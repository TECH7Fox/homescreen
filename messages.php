...
<script src="https://cdn.jsdelivr.net/gh/gitbrent/bootstrap4-toggle@3.6.1/js/bootstrap4-toggle.min.js"></script>
    <main class="container">
        <div class="card">
            <h3 class="card-header"><i class="fas fa-comment-dots"></i> Messages<button type="button" data-toggle="modal" data-target="#createMessage" class="btn btn-success btn-lg float-right"><i class="fas fa-plus"></i> Add new message</button></h3>
